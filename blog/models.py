...
class Article(models.Model):
    ...
    abstract = models.CharField('摘要', max_length=54, blank=True, null=True, help_text='可选，如若为空将摘取正文的前54个')
...
class Category(models.Model):
    ...
    last_modified_time = models.DateTimeField('修改时见', auto_now=True)
...
class BlogComment(models.Model):
    ...
    article = models.ForeignKey('Article', verbose_name='评论的文章', on_delete=models.CASCADE)
